...
import (
	...
	"github.com/neermitt/epc_exporter/collector"
)
...
func (h *handler) innerHandler(filters ...string) (http.Handler, error) {
	...
	r.MustRegister(version.NewCollector("epc_exporter"))
...
func main() {
	...
	kingpin.Version(version.Print("epc_exporter"))
	...
	http.HandleFunc("/", func(w http.ResponseWriter, r *http.Request) {
		w.Write([]byte(`<html>
			<head><title>Cisco EPC Exporter</title></head>
			<body>
			<h1>Cisco EPC Exporter</h1>
